...
SonucuGormekİstiyorum= True # sonucun sürekli gözükmesini önler.
def _CheckTheWin(p1: str, p2: str):
    ...
    global SonucuGormekİstiyorum
    ilksecim = TKM[p1]
    ikincisecim = TKM[p2]
    fark = ilksecim - ikincisecim
    if SonucuGormekİstiyorum:
...
def _PlayAgain():
    ...
    while True:
      ...
      _CheckTheWin(p1,p2)
      if devammı("evet"): SonucuGormekİstiyorum= True; continue # tekrar oynadığında sonuç tekrar gözükmeli
